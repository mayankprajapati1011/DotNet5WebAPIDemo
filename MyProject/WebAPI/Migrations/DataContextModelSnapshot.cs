...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessLayer.Dtos.ZoneWiseBinCollectionReport", b =>
                {
            ...
            modelBuilder.Entity("BusinessLayer.Entity.Area", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BusinessLayer.Entity.Bin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BusinessLayer.Entity.BinCollectionTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("BinCollectionTransactions");
                });
            ...
            modelBuilder.Entity("BusinessLayer.Entity.Society", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BusinessLayer.Entity.Zone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BusinessLayer.Entity.Area", b =>
                {
                    b.HasOne("BusinessLayer.Entity.Zone", "Zone")
                        .WithMany()
            ...
            modelBuilder.Entity("BusinessLayer.Entity.BinCollectionTransaction", b =>
                {
                    b.HasOne("BusinessLayer.Entity.Bin", "Bin")
                        .WithMany()
                        .HasForeignKey("BinId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BusinessLayer.Entity.Society", "Society")
                        .WithMany()
            ...
            modelBuilder.Entity("BusinessLayer.Entity.Society", b =>
                {
                    b.HasOne("BusinessLayer.Entity.Area", "Area")
                        .WithMany()
            ...
            modelBuilder.Entity("BusinessLayer.Entity.Zone", b =>
                {
                    b.HasOne("BusinessLayer.Entity.City", "City")
                        .WithMany()
